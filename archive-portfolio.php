				...
				<div class="image">
					...
					<div class="image-extras">
						<div class="image-extras-content">
							...
							?>
							<a style="<?php echo $zoom_icon_css; ?>" class="icon gallery-icon" href="<?php echo $full_image[0]; ?>" rel="prettyPhoto[gallery]" title="<?php echo get_post_field('post_content', get_post_thumbnail_id($post->ID)); ?>"><img style="display:none;" alt="<?php echo get_post_field('post_excerpt', get_post_thumbnail_id($post->ID)); ?>" src="none"/>Gallery</a>
							<h3><?php the_title(); ?></h3>
